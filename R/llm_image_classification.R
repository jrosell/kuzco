...
llm_image_classification <- \(llm_model = "llava-phi3",
  ...
  if(backend == 'ollamar'){
    ...
    kuzco:::ollamar_image_classification(llm_model     = llm_model,
    ...
    kuzco:::ellmer_image_classification(llm_model     = llm_model,
                                        image_prompt  = image_prompt,
                                        image         = image,
                                        system_prompt = system_prompt,
                                        ...)
...
ollamar_image_classification <- \(llm_model     = llm_model,
                                  image_prompt  = image_prompt,
                                  image         = image,
                                  system_prompt = system_prompt,
                                  ...
...
ellmer_image_classification <- \(llm_model     = llm_model,
                                 image_prompt  = image_prompt,
                                 image         = image,
                                 system_prompt = system_prompt,
                                 ...){
